...
## 職務要約
NaaSやモバイルコアの自社開発および運用、ゲーム機向けSDKの開発など、ソフトウェアからインフラまで幅広い領域のシステム開発に携わってきました。

特にCやGoを中心とした高性能なネットワーク処理の実装やクラウド基盤の最適化により、性能向上とコスト削減を同時に実現し、OSSへの継続的な貢献も行っています。
また、開発チームのリーダーとして、プロダクトの提案からPoCの実施、プロダクション投入までを一貫して推進してきました。
さらに、社内勉強会の主催や若手エンジニアの育成、外部での登壇や技術ブログの執筆を通じて知見の共有に努め、組織および技術コミュニティの発展に寄与しています。

課題解決に向けた主体的な行動力と確かな技術力を強みとして、プロジェクトの推進と人材育成の両面に取り組んできました。
...
### 仮想基盤開発(2025/10〜現在)
* 説明: NaaS 事業者として、NFV向け仮想基盤をゼロから自社開発し、研究・プロダクト開発のリードを担当
* プログラミング言語: Go, Python, Terraform, Ansible など
* その他キーワード: Linux, OvS-DPDK, etcd, libvirt, FRR, EVPN-VXLAN, ConnectRPC, Google Cloud, GitHub Actions
* 業務内容
  * 仮想ルーターをメインターゲットにした仮想基盤の開発
  * 既存サービス網との相互接続のNW設計から、ソフトウェア仕様設計を担当
  * プロダクト設計としての提案からPoC、導入の実現に向けてのリードしている
* 実績
  * 3~5名ほどのチームのリーダーとして人・技術両方の面からプロジェクトを牽引
    * 学生アルバイト等を含めると最大8名ほど
  * クラスタ間でのデータのやり取りなどを含めた仮想基盤クラスタの設計・開発を実施
    * ミドルウェアの採用やアーキテクチャは全てにおいて自分が関わっています
  * それらのサービス開発に向けた求人票（JD）の作成も担当し、自らの登壇発表などの外部露出を通じてチームメンバー採用に貢献しました
...
## 資格
* Google Cloud Professional Cloud Architect: 2025/12
